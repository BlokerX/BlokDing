...
namespace Kurs__Budowanie_kompletnej_apk_
{
    public partial class Form1 : Form
    {
        ...
        private SoundPlayer scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Vibrattharm);
        ...
        private void bPrzywrocDomyslne_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                soundTrack = "";
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Vibrattharm);
        ...
        private void bOdsluchaj_Click(object sender, EventArgs e)
        {
            ...
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.So_small);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 2) // Dla opcji 2
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Falls);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 3) // Dla opcji 3
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Attention);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 4) // Dla opcji 4
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Waterfall);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 5) // Dla opcji 5
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Boom);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 6) // Dla opcji 6
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Chilldown);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 7) // Dla opcji 7
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Spreading);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 8) // Dla opcji 8
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.My_Call);
                simpleSound.Play();
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 9) // Dla opcji 9
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Harmony);
                simpleSound.Play();
            }
            else if (true) //Domyslny alarm
            {
                SoundPlayer simpleSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Vibrattharm);
                simpleSound.Play();
            }
        }
        ...
        private void bZastosujUstawienia_Click(object sender, EventArgs e)
        {
            ...
            if (cbWyborAlarmuWgranego.SelectedIndex == 1) // Dla opcji 1
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.So_small);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 2) // Dla opcji 2
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Falls);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 3) // Dla opcji 3
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Attention);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 4) // Dla opcji 4
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Waterfall);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 5) // Dla opcji 5
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Boom);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 6) // Dla opcji 6
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Chilldown);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 7) // Dla opcji 7
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Spreading);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 8) // Dla opcji 8
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.My_Call);
            }
            else if (cbWyborAlarmuWgranego.SelectedIndex == 9) // Dla opcji 9
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Harmony);
            }
            else if (true) //Domyslny alarm
            {
                scieszkaWgranegoAlarmu = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources.Vibrattharm);
        ...
        private void popupNotifier_Designer()
        {
            ...
            popupNotifier.ContentText =
                "Alarm: wyłączony" +
                "\nWłącz alarm aby uruchomić odliczanie";
            popupNotifier.Image = Kurs__Budowanie_kompletnej_apk_.Properties.Resources.BigIconImage;
        ...
        {
            SoundPlayer EndOfSound = new SoundPlayer(Kurs__Budowanie_kompletnej_apk_.Properties.Resources._ENDOFSOUND_);
            EndOfSound.Play();
        }
